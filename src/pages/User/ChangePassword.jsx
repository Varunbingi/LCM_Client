    ...
    return (
        <HomeLayout>
            <div className="h-[90vh] flex justify-center items-center">
                <div className="shadow-[0_0_10px_black] flex flex-col justify-center space-y-10 items-center p-10">
                    <h1 className="text-yellow-500 text-2xl font-bold">
                        Change Password
                    </h1>
                    <form onClick={onFormSubmit} className="flex flex-col space-y-3 w-full text-white">
